...
void saveModel(const torch::nn::Module& model, const std::string& fileName) {
...
int main() {
    ...
    //train
    auto train_dataset = torch::data::datasets::MNIST(root)
    ...
    std::string modelFileName = "trained_model.pt";  // Specify the filename to save the model
